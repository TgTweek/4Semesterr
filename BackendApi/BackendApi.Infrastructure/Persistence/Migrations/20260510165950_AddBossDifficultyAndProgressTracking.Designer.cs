...
namespace BackendApi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260510165950_AddBossDifficultyAndProgressTracking")]
    partial class AddBossDifficultyAndProgressTracking
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BackendApi.Domain.Entities.Player", b =>
                {
                    ...
                    b.Property<int>("HighestDifficultyTierReached")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("BackendApi.Domain.Entities.PlayerCard", b =>
                {
                    ...
                    b.HasIndex("PlayerId", "LoadoutOrder")
                        .IsUnique()
                        .HasFilter("[LoadoutOrder] IS NOT NULL");

                    b.HasIndex("PlayerId", "Location");
